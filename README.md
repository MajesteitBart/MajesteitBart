...
I work with B2B companies on AI strategy (what to build and why), implementation (actually building it), and enablement (workshops, use case development, getting teams up to speed).
